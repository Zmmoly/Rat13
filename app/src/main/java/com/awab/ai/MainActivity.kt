...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Hide action bar (black header)
        supportActionBar?.hide()
        
        // Main container - RelativeLayout for proper keyboard behavior
        ...
        inputArea.id = android.view.View.generateViewId()
        ...
        // Chat area (scrollable) - above input
        scrollView = ScrollView(this).apply {
            val scrollParams = RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.MATCH_PARENT,
                RelativeLayout.LayoutParams.MATCH_PARENT
            )
            scrollParams.addRule(RelativeLayout.ABOVE, inputArea.id)
